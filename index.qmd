...
- [Lecture slides](slides/day_1/1.SlidesDescriptives.pdf.qmd)
- Contents:
...
- Exercises:
  ...
  - [R studio version](handouts/day_1/ExerciseRStudio.html){target="_blank"}; [Exercise script](handouts/day_1/ExerciseCode.R){target="_blank"}
- Answers: 
